...
{
   // ArrayList for storing the model.Student objects
	...
	// Add a model.Student to the list
	public void add(Student student)
	{
		students.add(student);
	}
  
	// Replace the model.Student object at index with student
	public void set(Student student, int index)
	{
		students.set(index, student);
	}

	// Return the model.Student object at index if one exists,
	// else return null
	...
	// Get the model.Student object with the given firstName and lastName
	...
	// Return the index of the model.Student object with the given
	...
	// Return how many model.Student objects are in the list
	public int size()
	{
	...
	// with many model.Student objects, so I make my own toString and
